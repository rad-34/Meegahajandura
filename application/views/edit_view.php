...
<form method=POST class="form-group" action="<?php base_url();?>/meegahajandura/RadCI/index.php/Schedule_CI/update/<?php echo $rw->SID; ?>">
    <div class="form-group col-xs-12 col-sm-12 col-md-12 jumbotron">
        <legend class="col-lg-10 col-lg-offset-2">Update Schedule</legend>
			<div class="form-group col-xs-12 col-sm-12 col-md-12">
				...
				<div class="col-lg-10">
					<input type="date" required name="inputDate" class="form-control" value="<?php echo $rw->Date; ?>">
				</div>
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-12">
				<label for="inputTime" class="col-lg-2 control-label">Time</label>
				<div class="col-lg-10">
					<input type="time" required name="inputTime" class="form-control" value="<?php echo $rw->Time; ?>">
				</div>
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-12">
				<label for="inputPlc" class="col-lg-2 control-label">Place</label>
				<div class="col-lg-10">
					<input type="text" required name="inputPlc" class="form-control" value="<?php echo $rw->Place; ?>">
				</div>
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-12">
				<label for="inputDesc" class="col-lg-2 control-label">Description</label>
				<div class="col-lg-10">
					<input type="text" required name="inputDesc" class="form-control" value="<?php echo $rw->Description; ?>">
				</div>
            </div>
