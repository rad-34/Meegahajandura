...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col shadow-sm bg-white h-100">
            ...
            <?php
      if($_SESSION['role']=='A'){
            echo'<h3 align="center"><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#insertModal">Insert a family member</button></h3>';}?>
        ...
        <div class="modal-body">
            <form action="<?php echo base_url();?>/index.php/peopledetails/family_member_add" method="post" id="insert-form">
                ...
                <div class="form-label">
                    ...
                    <input type="text" class="form-control" required name="insert_relationship"  id="insert_relationship" placeholder="Enter Relationship">
                </div>
                <br>
                <div class="form-label">
                ...
                <br>
                <div class="form-label">
                    <input type="hidden" value="<?php echo $h->id;?>" required class="form-control" name="insert_house_holder"  id="insert_house_holder" placeholder="Enter the HouseHolder ID">
                </div>
                <br>               
