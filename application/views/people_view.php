        ...
        <div class="modal-body">
            <form action="<?php echo base_url();?>index.php/peopledetails/people_add" method="post" id="insert-form">
                <div class="form-label">
                    ...
                    <input type="text" class="form-control" required name="insert_nic"  id="insert_nic" placeholder="Enter NIC">
                </div>
                <br>
                <div class="form-label">
                    <label for="name">Full Name</label>
                    <input type="text" class="form-control" required name="insert_name" id="insert_name" placeholder="Enter Full Name">
                </div>
                <br>
                <div class="form-label">
                    <label for="address">Address</label>
                    <input type="text" class="form-control" required name="insert_address" id="insert_address" placeholder="Enter Address">
                </div>
                <br>
                <div class="form-label">
                    <label for="phone">Phone Number</label>
                    <input type="text" class="form-control" required name="insert_phone_no"  id="insert_phone_no" placeholder="Enter Phone No">
                </div>
                <br>
                <div class="form-label">
                    <label for="job">Job</label>
                    <input type="text" class="form-control" required name="insert_job"  id="insert_job" placeholder="Enter the Job">
                </div>
                <br>
                <div class="form-label">
                    <label for="role">Role</label>
                    <select class="form-control" required name="insert_role" id="insert_role">
                ...
                <div class="form-label">
                    ...
                    <select class="form-control" required name="insert_status" id="insert_status">
                ...
                <div class="form-label">
                    ...
                    <input type="text" class="form-control" required name="insert_password"  id="insert_password" placeholder="Enter the Password">
                </div>
                <br>
