	...
	<legend class="col-lg-10 col-lg-offset-2">Enter New Schedule</legend>
		...
		<div class="form-group col-xs-12 col-sm-12 col-md-12">
			<div class="form-group col-xs-12 col-sm-12 col-md-12">
				...
				<div class="col-lg-10">
					<input type="date" required name="inputDate" class="form-control">
				</div> 
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-12">
				<label for="inputTime" class="col-lg-2 control-label">Time</label>
				<div class="col-lg-10">
					<input required type="time" name="inputTime" class="form-control">
				</div>
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-12">
				<label for="inputPlc" class="col-lg-2 control-label">Place</label>
				<div class="col-lg-10">
					<input type="text" required name="inputPlc" class="form-control" placeholder="Place">
				</div>
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-12">
				<label for="inputDesc" class="col-lg-2 control-label">Description</label>
				<div class="col-lg-10">
					<input type="text" required name="inputDesc" class="form-control" placeholder="Description">
				</div>
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-12">
